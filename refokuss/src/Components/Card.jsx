...
function Card({width,start,para,hover="false"}) {
  ...
  return (
    <motion.div whileHover={{backgroundColor:hover==="true" && "#7443ff",padding:"23px"}} className={`bg-zinc-700 p-5 rounded-xl  ${width} min-h-[30rem] flex flex-col justify-between`} >
