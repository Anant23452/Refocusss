      ...
      <div className="nleft flex items-center">
        ...
        <div className="links flex gap-10 ml-7">
          {["Home", "About", "Contact", "Blog", "Career"].map((item, index) => (
            <a href="" className="text-white flex items-center g-1">
              {item.length === 6 ? (
                <span className="w-[2px] h-3 bg-zinc-500 mr-1 "></span>
              ) : null}
              {index === 1 && (
                <span
                  style={{ boxShadow: "0 0 0.25em #00FF19" }}
                  className="inline-block w-1 h-1 rounded-full bg-green-300 "
                ></span>
              )}
              {item}{" "}
            </a>
